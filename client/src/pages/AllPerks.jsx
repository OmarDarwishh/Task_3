...
*/
  ...
  async function loadAllPerks(search = searchQuery, merchant = merchantFilter) {
  ...
  function handleSearch(e) {
    ...
    loadAllPerks(searchQuery, merchantFilter);
  }
  ...
  function handleReset() {
    ...
    setSearchQuery("");
    setMerchantFilter("");
    // Load all perks immediately with no filters
    loadAllPerks("", "");
  }

  // ==================== EFFECTS: initial load + auto-search (debounced) ====================
      ...
      <div className="card">
        <form onSubmit={handleSearch} className="space-y-4">
          ...
          <div className="flex gap-3 items-center">
            ...
            {/* Loading indicator (icon only — text removed) */}
            {loading && (
              <div
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        */}
        ...
        {loading && perks.length === 0 && (
          <div
            className="col-span-full text-center py-12 text-zinc-600"
            aria-hidden="true"
          >
